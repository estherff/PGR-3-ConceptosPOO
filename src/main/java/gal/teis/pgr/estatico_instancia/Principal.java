                ...
                switch (pintarMenu()) {
                    ...
                    case 2://Ingresar en una cuenta bancaria
                        ...
                        do {
                            ...
                            CuentaBancaria111 unaCuenta = todasLasCuentas.get(i);
                            if (unaCuenta.getNCuenta().equals(nCuenta)) {
                                encontrado = true; // Terminar ciclo, pues ya lo encontramos
                            } else {
                                i++;
                            }
                        } while (!encontrado && i < todasLasCuentas.size());
                        ...
                        if (encontrado) {
                            ...
                            do {
                                ...
                                boolean realizado = todasLasCuentas.get(i).hacerIngreso(aIngresar);
                                ...
                                if (realizado) {
                                    System.out.println("El ingreso se ha realizado con éxito. "
                                            ...
                                            + todasLasCuentas.get(i).getSaldo());
                    ...
                    case 3://Retirar dinero de una cuenta bancaria
                        ...
                        if (encontrado) {
                            ...
                            do {
                                ...
                                boolean realizado = todasLasCuentas.get(i).hacerReintegro(aRetirar);
                                //Si el ingreso se ha realizado con éxito
                                if (realizado) {
                    ...
                    case 4://Recalcular el interés aplicado en una cuenta bancaria
                        ...
                        if (encontrado) {
                            ...
                            CuentaBancaria111.calcularInteres(todasLasCuentas.get(i));

                            System.out.println("El interés que se aplicará a "
                                    + "la cuenta en la situació actual es de "
                                    + todasLasCuentas.get(i).getTipoInteres());
                    ...
                    case 5://Ver información de una cuenta bancaria
                        ...
                        if (encontrado) {
                            System.out.println("La información de la cuenta es "
                                    + todasLasCuentas.get(i).cuentaComoString());
                    ...
                    case 6://Ver información de todas las cuentax bancarias
                        System.out.println("\n********************************************\n"
